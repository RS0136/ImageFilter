...
- **お絵かきレイヤー**の追加、ブラシ / 消しゴム、色・サイズ・不透明度の調整に対応
- **8種類のブラシ**（ハード丸 / ソフト丸 / スクエア / カリグラフィ / マーカー / エアブラシ / チョーク / ピクセル）
- **5種類の消しゴム**（ハード丸 / ソフト丸 / ブロック / スプレー / テクスチャ）
- フィルターを**スタック式**で追加・並べ替え・ON/OFF可能
- **比較表示**で元画像と加工後を見比べ可能
- **PNG / JPEG 書き出し**対応
- **ドラッグ＆ドロップ / ペースト**対応
...
4. 描画レイヤーを選び、ブラシ種類 / 消しゴム種類を選んで描き込みます
5. 左側からフィルターを追加し、比較表示で確認します
6. PNG または JPEG で書き出します
